...
namespace characterBal
{
    ...
    { 
        ...
        static string spreadSheetID = "18Ms2V9PcDIDCSEFDwJUBGFHbWg6WKh7q_1kbEc36Zck"; // it is file id
...
/* Your Loaded Data Storage. */
        ...
        /// <summary>
        /// Get Balance Dictionary, keyType is your sheet A1 field type.
        /// - Auto Load
        /// </summary>
        public static Dictionary<int, Balance>  GetDictionary()
        {{
           if (isLoaded == false) Load();
           return BalanceMap;
        }}
...
#region fuctions
        ...
        public static void Load(bool forceReload = false)
        {
            ...
            {
#if UGS_DEBUG
                 Debug.Log("Balance is already loaded! if you want reload then, forceReload parameter set true");
#endif
                 return;
            }

            string text = reader.ReadData("characterBal"); 
            if (text != null)
            {
    ...
    public static (List<Balance> list, Dictionary<int, Balance> map) CommonLoad(Dictionary<string, Dictionary<string, List<string>>> jsonObject, bool forceReload){
